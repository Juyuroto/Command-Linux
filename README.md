...
Un petit outil qui liste les commandes Linux les plus utiles avec description et exemple pour chacune.
...
```bash
git clone https://github.com/Juyuroto/Command-Linux
cd Command-Linux
mv .env.example .env
